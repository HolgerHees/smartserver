...
$reason = (isset($status_reason[$code]) ? $status_reason[$code] : '');
$message = (isset($status_message[$code]) ? str_replace('%U%', htmlspecialchars(strip_tags(stripslashes($_SERVER['REQUEST_URI']))), $status_message[$code]) : 'Error');
