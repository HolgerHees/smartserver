...
subGroup.addHtml('guest_wifi', ['admin'], '<div class="service guestwifi" style="text-align: center;text-shadow: var(--submenu-shadow-service-info);"><img class="obfuscated" src="/guest_wifi/?name={{name}}&obfuscated=1"><img class="deobfuscated" src="/guest_wifi/?name={{name}}&obfuscated=0"><div class="wifiname">{{name}}</div></div>', { 'order': 380, 'callbacks': { "init": [ mx.GuestWifi.init ] }, 'title': '{i18n_Guest Wifi}', 'info': '{i18n_QRCode}', 'icon': 'guest_wifi.svg' });
{% endfor %}
