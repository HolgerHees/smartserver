...
subGroup.addHtml('guest_wifi', '<div class="service" style="text-align: center;"><img src="/guest_wifi/?name={{network}}"><div>{{network}}</div></div>', function(){}, 'admin', 380, '{i18n_Guest Wifi}', '{i18n_QRCode}', "guest_wifi.svg");
{% endfor %}
