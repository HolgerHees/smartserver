...
<?php
    ...
    if( count($states) == 0 )
    {
        echo "<div style=\"text-align: center\">No software versions checked.<br><br>Please run '/opt/update_service/software_version_check' or wait until related cronjob was running.</div>";
    }
    else
    {
?>
