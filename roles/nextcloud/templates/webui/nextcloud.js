...
subGroup.addUrl('photos', ['user'], '//nextcloud.{host}/index.php/apps/photos/', { 'order': 111, 'title': '{i18n_Photos}', 'info': '{i18n_Gallery}', 'icon': 'nextcloud_photos.svg', 'callbacks': { 'ping': mx.Nextcloud.applyTheme } });
