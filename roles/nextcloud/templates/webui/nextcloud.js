...
subGroup.addUrl('documents',100, 'url', '//nextcloud.{host}/', '{i18n_Documents}', '', false, 'files.svg');
subGroup.addUrl('news',200, 'url', '//nextcloud.{host}/index.php/apps/news/', '{i18n_News}', '', false);
subGroup.addUrl('keeweb',300, 'url', '//nextcloud.{host}/index.php/apps/keeweb/', '{i18n_Keys}', '{i18n_Keeweb}', false);
