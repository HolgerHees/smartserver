...
subGroup.addUrl('notes','//nextcloud.{host}/index.php/apps/notes/', ['user','nextcloudadmin'], 110, '{i18n_Notes}', '{i18n_Notes_Infos}', false, 'nextcloud_notes.svg');
subGroup.addUrl('photos','//nextcloud.{host}/index.php/apps/photos/', ['user','nextcloudadmin'], 111, '{i18n_Photos}', '{i18n_Gallery}', false, 'nextcloud_photos.svg');
