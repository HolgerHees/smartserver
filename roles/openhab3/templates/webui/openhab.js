...
subGroup.addUrl('mainui', '//openhab.{host}/', 'admin', 200, '{i18n_Administration}', '{i18n_Main UI}', false, 'openhab_adminui.svg');
subGroup.addUrl('habot', '//openhab.{host}/habot', 'user', 300, '{i18n_Chatbot}', '{i18n_Habot}', false, 'openhab_habot.svg');
