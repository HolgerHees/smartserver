...
subGroup.addUrl('gateway', 'https://{{server_gateway}}', 'admin', 220, '{i18n_Router}', '{i18n_FritzBox}', "device_wifi.svg", true);
subGroup.addUrl('camera', 'http://{{camera_streedside_ip}}', 'admin', 310, '{i18n_Camera}', '{i18n_Streedside}', "device_camera.svg", true);
